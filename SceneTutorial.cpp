...
void SceneTutorial::init() {
	Scene::init("images/background.png", "levels/Tutorial.txt");

	ogre1 = new EnOgre();
	ogre1->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram);
	ogre1->setPosition(glm::vec2(INIT_PLAYER_X_TILES * map->getTileSize(), INIT_PLAYER_Y_TILES * map->getTileSize()));
